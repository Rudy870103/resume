                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="font-family: 'Noto Serif TC', serif;font-weight:700">
                            ...
                            <li class=" nav-item">
                                <a class="nav-link" href="?do=web-design">網頁作品</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?do=graphic-design">平面作品</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?do=animate">一些作業延伸</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="?do=contact">聯絡方式</a>
                            </li>
                        </ul>
                    </div>
                    <div class="login">
